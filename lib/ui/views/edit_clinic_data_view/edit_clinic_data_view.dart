...
import 'edit_clinic_data_view_model.dart';

class CustomerEditClinicDataView extends StatefulWidget {
  const CustomerEditClinicDataView({Key? key}) : super(key: key);

  @override
  State<CustomerEditClinicDataView> createState() =>
      _CustomerEditClinicDataViewState();
}

class _CustomerEditClinicDataViewState
    extends State<CustomerEditClinicDataView> {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CustomerEditClinicDataViewModel>.nonReactive(
      viewModelBuilder: () => CustomerEditClinicDataViewModel(),
