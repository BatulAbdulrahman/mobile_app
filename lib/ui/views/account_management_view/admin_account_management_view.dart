...
import '../edit_admin_data_view/edit_admin_data_view.dart';
import 'admin_account_management_view_model.dart';

class CustomerAdminAccountManagementView extends StatefulWidget {
  const CustomerAdminAccountManagementView({Key? key}) : super(key: key);

  @override
  State<CustomerAdminAccountManagementView> createState() =>
      _CustomerAdminAccountManagementViewState();
}

class _CustomerAdminAccountManagementViewState
    extends State<CustomerAdminAccountManagementView> {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<
            CustomerAdminAccountManagementViewModel>.nonReactive(
        viewModelBuilder: () => CustomerAdminAccountManagementViewModel(),
              ...
              Container(
                ...
                child: Header(
                  ...
                  buttonPress: () {
                    showDialog(
                      context: context,
                      builder: (context) => CustomerEditAdminDataView(),
                    );
                  },
                ),
              )),
